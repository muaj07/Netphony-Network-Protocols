...
//		}
		...
		if (localNodeDescriptors!=null){
			//System.out.println("Encoder Offset Before:  "+offset);
			...
			//System.out.println("Encoder Offset After :  "+offset);
	...
	public void decode(){
		...
		while (lengthResourcesgeted<lengthITNodeNLRI){
			...
			//System.out.println("Decoder Offset Before:  "+offset);
			offset+=lengthResource;
			//System.out.println("Decoder Offset After:  "+offset);
		...
		offset= offset- lengthResource-4;
		//System.out.println("Decoder Offset Befor:  "+offset);

		this.localNodeDescriptors=new LocalNodeDescriptorsTLV(this.bytes, offset);
		offset = offset + localNodeDescriptors.getTotalTLVLength();

		//System.out.println("Decoder Offset Afte:  "+offset);
	...
	public String toString() {
		return "ITNode NLRI [nodeID=" + nodeId + "controllerIT=" + controllerIT + ", cpu="
				+ cpu + ", mem="
				+ mem+  ", storage="+ storage+"]  Local Node Descriptor: " +localNodeDescriptors.toString();
	}
