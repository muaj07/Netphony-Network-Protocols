...
public abstract class BGP4Message  implements BGP4Element {
	...
	protected void encodeHeader() { 
		for (int i = 0;i<16;i++)
		messageBytes[i]=(byte)0xFF; //Marker Field of the Header
		messageBytes[16]=(byte)((messageLength>>8) & 0xFF);//First Byte of Length field
		messageBytes[17]=(byte)(messageLength & 0xFF);//Second Byte of Length Field
		messageBytes[18]=(byte)messageType;//1-Byte Type Field
	}
