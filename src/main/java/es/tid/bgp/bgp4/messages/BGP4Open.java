...
public class BGP4Open extends BGP4Message {
	...
	public void encode(){// throws PCEPProtocolViolationException {	
		...
		offset=offset+2;
		System.arraycopy(BGPIdentifier.getAddress(),0, messageBytes, offset, 4);//4-Byte BGP Identifier
		offset=offset+4;
		messageBytes[offset] = (byte)(optionalParameterLength & 0xff);//1-Byte Optional Length
		offset++;
